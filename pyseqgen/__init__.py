...
_user_cfg_dir = os.path.expanduser("~/.pyseqgen")
...
def get_logger(s):
    """Wrapper around logging.getLogger that make sure that the pyseqgen
    ...
    if not _logger_initialized:
        ...
        filename = "logging_pyseqgen.conf"
        full_path = get_pyseqgen_cfg_file(filename)
